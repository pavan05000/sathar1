        ...
        <div class="breadcrumb-area breadcrumb-mt bg-gray breadcrumb-ptb-1">
            <div class="container">
                <div class="breadcrumb-content">
                    ...
                    <a href="index.php">Home</a>/<a href="#">Shop</a>/<a href="mats.php">Prayer Mats</a>
                </div>
            </div>
                ...
                <div class="col-lg-9">
                        <div class="tab-content">
                            ...
                            <div id="shop-categorie-2" class="tab-pane active">
                                ...
                                <div class="tab-content pt-30">
                                <div>
                                    <h4>Find Serenity: Prayer Mats for Your Spiritual Practice :</h4>
                                    <p>We understand the importance of creating a peaceful and comfortable space for your spiritual practice. Our collection of prayer mats offers a variety of styles and materials to suit your needs and preferences.</p>
                                    <p>Find beautiful and functional prayer mats adorned with intricate designs or crafted from luxurious fabrics. Choose a mat that inspires tranquility and allows you to fully immerse yourself in your devotions.</p>
                                       <br> 
                                </div>
                            ...
                            <div class="sidebar-widget">
                                ...
                                <div class="sidebar-widget-categori mt-45 mb-70">
                                    <ul>
                                        ...
                                        <li><a class="active" href="mats.php">Prayer Mats</a> </li>
                                        <li><a href="abayas.php">Abayas</a> </li>
                                        <li><a href="niche-items.php"> Niche Items </a> </li>
