        ...
        <div class="breadcrumb-area breadcrumb-mt bg-gray breadcrumb-ptb-1">
            <div class="container">
                <div class="breadcrumb-content">
                    ...
                    <a href="index.php">Home</a>/<a href="#">Shop</a>/<a href="attar.php">Attar</a>
                </div>
            </div>
                ...
                <div class="col-lg-9">
                        <div class="tab-content">
                            ...
                            <div id="shop-categorie-2" class="tab-pane active">
                                ...
                                <div class="tab-content pt-30">
                                <div>
                                    <h4>Awaken Your Senses: The Enchanting World of Attar :</h4>
                                    <p>Attar, the art of exquisite essential oils, is a journey for the senses. We invite you to explore our collection of captivating fragrances, each crafted with the finest natural ingredients.</p>
                                    <p>Discover the invigorating essence of citrus, the calming warmth of sandalwood, or the alluring depth of musk. Find a fragrance that complements your personality and creates a lasting impression.</p>
                                       <br> 
                                </div>
                            ...
                            <div class="sidebar-widget">
                                ...
                                <div class="sidebar-widget-categori mt-45 mb-70">
                                    <ul>
                                        ...
                                        <li><a  href="mobile.php">Mobile Accessories</a> </li>
                                        <li><a  href="books.php">Books</a> </li>
                                        <li><a class="active" href="attar.php">Attar</a> </li>
                                        <li><a href="mats.php">Prayer Mats</a> </li>
                                        <li><a href="abayas.php">Abayas</a> </li>
                                        <li><a href="niche-items.php"> Niche Items </a> </li>
