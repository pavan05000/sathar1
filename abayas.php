        ...
        <div class="breadcrumb-area breadcrumb-mt bg-gray breadcrumb-ptb-1">
            <div class="container">
                <div class="breadcrumb-content">
                    ...
                    <a href="index.php">Home</a>/<a href="#">Shop</a>/<a href="abayas.php">Abayas</a>
                </div>
            </div>
                ...
                <div class="col-lg-9">
                        <div class="tab-content">
                            ...
                            <div id="shop-categorie-2" class="tab-pane active">
                                ...
                                <div class="tab-content pt-30">
                                <div>
                                    <h4>Embrace Elegance: Discover the Perfect Abaya :</h4>
                                    <p>The abaya is a timeless symbol of modesty and elegance. We offer a curated selection of abayas designed to flatter every figure and style, ensuring you feel confident and comfortable in your faith.</p>
                                    <p>Explore a range of abayas crafted from flowing fabrics and adorned with beautiful details. Find the perfect abaya for everyday wear, special occasions, or simply to express your personal style.</p>
                                       <br> 
                                </div>
                            ...
                            <div class="sidebar-widget">
                                ...
                                <div class="sidebar-widget-categori mt-45 mb-70">
                                    <ul>
                                        ...
                                        <li><a  href="mats.php">Prayer Mats</a> </li>
                                        <li><a class="active" href="abayas.php">Abayas</a> </li>
                                        <li><a href="niche-items.php"> Niche Items </a> </li>
