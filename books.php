        ...
        <div class="breadcrumb-area breadcrumb-mt bg-gray breadcrumb-ptb-1">
            <div class="container">
                <div class="breadcrumb-content">
                    ...
                    <a href="index.php">Home</a>/<a href="#">Shop</a>/<a href="books.php">Books</a>
                </div>
            </div>
                ...
                <div class="col-lg-9">
                        <div class="tab-content">
                            ...
                            <div id="shop-categorie-2" class="tab-pane active">
                                ...
                                <div class="tab-content pt-30">
                                <div>
                                    <h4>Dive Deeper: Explore a World of Captivating Reads :</h4>
                                    <p>We believe books have the power to transport us, educate us, and inspire us. Our curated selection offers something for every mood and interest, from captivating fiction to insightful non-fiction, academic texts, and self-help guides.</p>
                                    <p>Get lost in a thrilling mystery, delve into historical accounts, or empower yourself with practical advice. Whether you're a seasoned reader or just starting your literary journey, we have the perfect book waiting to be discovered.</p>
                                       <br> 
                                </div>
