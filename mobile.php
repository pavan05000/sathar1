...
<!-- Mirrored from demo.hasthemes.com/dking-preview/dking/shop.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Apr 2024 19:31:15 GMT -->
<?php 
include("header.php");
?>
...
<body>
    ...
    <div class="main-wrapper main-wrapper-3">
        ...
        <div class="breadcrumb-area breadcrumb-mt bg-gray breadcrumb-ptb-1">
            <div class="container">
                <div class="breadcrumb-content">
                    ...
                    <a href="index.php">Home</a>/<a href="#">Shop</a>/<a href="mobile.php">Mobile Accessories</a>
                </div>
            </div>
                    ...
                    <div class="custom-col-8">
                        <div class="single-categories-5 text-center">
                            <div class="single-categories-5-img">
                                <a href="shop.php"><img class="inject-me" src="assets/images/icon-img/furniture-dress.svg" alt=""></a>
                            </div>
                            <div class="categorie-content-6">
                                <h4><a class="color-light" href="shop.php">Fashion</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="custom-col-8">
                        <div class="single-categories-5 text-center">
                            <div class="single-categories-5-img">
                                <a href="shop.php"><img class="inject-me" src="assets/images/icon-img/furniture-headphone.svg" alt=""></a>
                            </div>
                            <div class="categorie-content-6">
                                <h4><a class="color-light" href="shop.php">Gadget</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="custom-col-8">
                        <div class="single-categories-5 text-center">
                            <div class="single-categories-5-img">
                                <a href="shop.php"><img class="inject-me" src="assets/images/icon-img/furniture-chair.svg" alt=""></a>
                            </div>
                            <div class="categorie-content-6">
                                <h4><a class="color-light" href="shop.php">Furniture</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="custom-col-8">
                        <div class="single-categories-5 text-center">
                            <div class="single-categories-5-img">
                                <a href="shop.php"><img class="inject-me" src="assets/images/icon-img/furniture-chair-2.svg" alt=""></a>
                            </div>
                            <div class="categorie-content-6">
                                <h4><a class="color-light" href="shop.php">Chair</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="custom-col-8">
                        <div class="single-categories-5 text-center">
                            <div class="single-categories-5-img">
                                <a href="shop.php"><img class="inject-me" src="assets/images/icon-img/furniture-book.svg" alt=""></a>
                            </div>
                            <div class="categorie-content-6">
                                <h4><a class="color-light" href="shop.php">Book</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="custom-col-8">
                        <div class="single-categories-5 text-center">
                            <div class="single-categories-5-img">
                                <a href="shop.php"><img class="inject-me" src="assets/images/icon-img/autos.svg" alt=""></a>
                            </div>
                            <div class="categorie-content-6">
                                <h4><a class="color-light" href="shop.php">Autos</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="custom-col-8">
                        <div class="single-categories-5 text-center">
                            <div class="single-categories-5-img">
                                <a href="shop.php"><img class="inject-me" src="assets/images/icon-img/bicycle.svg" alt=""></a>
                            </div>
                            <div class="categorie-content-6">
                                <h4><a class="color-light" href="shop.php">Bicycle </a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="custom-col-8">
                        <div class="single-categories-5 text-center">
                            <div class="single-categories-5-img">
                                <a href="shop.php"><img class="inject-me" src="assets/images/icon-img/fitness.svg" alt=""></a>
                            </div>
                            <div class="categorie-content-6">
                                <h4><a class="color-light" href="shop.php">Fitness</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="shop-area pt-60 pb-160">
            <div class="container">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="shop-categorie-2" class="tab-pane active">
                                <div class="shop-top-bar">
                                    <div class="shop-top-bar-left">
                                        <div class="shop-tab nav">
                                            <a href="#shop-3" class="active" data-toggle="tab"><img class="inject-me" src="assets/images/icon-img/shop-grid.svg" alt=""></a>
                                            <a href="#shop-4" data-toggle="tab"><img class="inject-me" src="assets/images/icon-img/shop-list.svg" alt=""></a>
                                        </div>
                                    </div>
                                    <!-- <div class="shop-top-bar-right">
                                        <div class="shop-page-list">
                                ...
                                <div class="tab-content pt-30">
                                <div>
                                    <h4>Express Yourself: Mobile Accessories with Style & Protection :</h4>
                                    <p>We know your phone is an extension of you. That's why we offer a curated selection of cases, chargers, headphones, and more that keep your device safe while reflecting your unique style.</p>
                                    <p>From sleek and sophisticated to playful and vibrant, find the perfect accessories to personalize your phone and make a statement. Explore durable cases that protect against everyday wear and tear, or discover innovative charging solutions that keep you connected on the go. From sleek and stylish cases to high-performance chargers and innovative headphones, we have everything you need to elevate your mobile experience.</p>
                                       <br> 
                                </div>
                            ...
                            <div id="shop-categorie-3" class="tab-pane">
                                <div class="shop-top-bar">
                                    <div class="shop-top-bar-left">
                                        <div class="shop-tab nav">
                                            <a href="#shop-5" class="active" data-toggle="tab"><img class="inject-me" src="assets/images/icon-img/shop-grid.svg" alt=""></a>
                                            <a href="#shop-6" data-toggle="tab"><img class="inject-me" src="assets/images/icon-img/shop-list.svg" alt=""></a>
                                        </div>
                                    </div>
                                    <!-- <div class="shop-top-bar-right">
                                        <div class="shop-page-list">
                    ...
                    <div class="col-lg-3">
                        <div class="shop-sidebar-style">
                            <div class="sidebar-widget">
                                <h4 class="pro-sidebar-title"></h4>
                                <div class="sidebar-widget-categori mt-45 mb-70">
                                    <ul>
                                        <!-- <li><a href="#">All</a> </li> -->
                                        <li><a class="active" href="mobile.php">Mobile Accessories</a> </li>
                                        <li><a href="books.php">Books</a> </li>
                                        <li><a href="attar.php">Attar</a> </li>
                                        <li><a href="mats.php">Prayer Mats</a> </li>
                                        <li><a href="abayas.php">Abayas</a> </li>
                                        <li><a href="niche-items.php"> Niche Items </a> </li>
...
<!-- Mirrored from demo.hasthemes.com/dking-preview/dking/shop.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Apr 2024 19:31:17 GMT -->
</html>