        ...
        <div class="breadcrumb-area breadcrumb-mt bg-gray breadcrumb-ptb-1">
            <div class="container">
                <div class="breadcrumb-content">
                    ...
                    <a href="index.php">Home</a>/<a href="#">Shop</a>/<a href="niche-items.php"> Niche Items </a>
                </div>
            </div>
                ...
                <div class="col-lg-9">
                        <div class="tab-content">
                            ...
                            <div id="shop-categorie-2" class="tab-pane active">
                                ...
                                <div class="tab-content pt-30">
                                <div>
                                    <h4>Unexpected Delights: Discover Unique Treasures :</h4>
                                    <p>We believe in the magic of finding something truly special. Our ever-growing collection of niche items offers a treasure trove of unique products that you won't find on every corner.</p>
                                    <p>From handcrafted jewelry and artisan homeware to specialty teas and travel accessories, embark on a journey of discovery and find that perfect piece to add a touch of individuality to your life.</p>
                                       <br> 
                                </div>
                            ...
                            <div class="sidebar-widget">
                                ...
                                <div class="sidebar-widget-categori mt-45 mb-70">
                                    <ul>
                                        ...
                                        <li><a  href="mats.php">Prayer Mats</a> </li>
                                        <li><a  href="abayas.php">Abayas</a> </li>
                                        <li><a class="active" href="niche-items.php"> Niche Items </a> </li>
